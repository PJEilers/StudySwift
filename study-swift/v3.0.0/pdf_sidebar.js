 ...
 * @property {HTMLButtonElement} summaryButton - The button used to show the attachments view
 ...
 * @property {HTMLDivElement} summaryView - The container in which the summary is placed
...
class PDFSidebar {
  ...
  constructor(options, l10n = NullL10n) {
    this.isOpen = false;
    this.active = SidebarView.SUMMARY;
    ...
    this.summaryButton = options.summaryButton;
    

    this.thumbnailView = options.thumbnailView;
    this.outlineView = options.outlineView;
    this.attachmentsView = options.attachmentsView;
    this.summaryView = options.summaryView;
  ...
  get isSummaryViewVisible() {
    return (this.isOpen && this.active === SidebarView.SUMMARY);  
  }
  ...
  switchView(view, forceOpen = false) {
    ...
    switch (view) {
      case SidebarView.THUMBS:
        ...
        this.summaryButton.classList.remove('toggled');
      ...
      case SidebarView.ATTACHMENTS:
        ...
        this.summaryView.classList.add('hidden');
        break;
    case SideBarView.SUMMARY:
        this.thumbnailButton.classList.remove('toggled');
        this.outlineButton.classList.remove('toggled');
        this.attachmentsButton.classList.remove('toggled');
        this.summaryButton.classList.add('toggled');
  ...
  _addEventListeners() {
    ...
    /*this.summaryButton.addEventListener('click', () => {
      this.switchView(SidebarView.SUMMARY);  
    });*/
